...
class HexaDec {
    ...
    fun loadWorkflow() : ArrayList<Workflow>{
        workflowList = GatewayController.readWorkflowPost(user)
        return workflowList
    }

    fun saveWorkflow(workflowName: String, blockList: ArrayList<Block>,create:String,modify:String,counter:Int){
